...
class BertNER(BertPreTrainedModel):
    def __init__(self, config, args):
        ...
        elif 'chinese' in self.args.bert_config_dir:
            print('use the chinese bert pre-trained model...')
            # 中文BERT模型可能需要特殊处理
    ...
    def forward(self, loadall, all_span_lens, all_span_idxs_ltoken, input_ids, token_type_ids=None,
                attention_mask=None):
        """
        Args:
        ...
        all_span_rep = self._endpoint_span_extractor(sequence_heatmap,
                                                     all_span_idxs_ltoken.long())  # [batch, n_span, hidden]
